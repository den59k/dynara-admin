...
const en: Messages = {
  ...
  "dashboard.empty": "No widgets configured",
  "data.add": "Add item",
  "data.search": "Search…",
  "data.loading": "Loading…",
  "data.empty": "No items yet",
  "data.emptySearch": "Nothing found",
  "data.clearSearch": "Clear search",
  "data.error": "Couldn't load data",
  "data.retry": "Retry",
  "filter.clear": ({ count }: { count: number }) => `Clear ${count > 1 ? "filters" : "filter"}`,
  "filter.all": "All",
  "data.delete": ({ count }: { count: number }) => (count > 1 ? "Delete items" : "Delete item"),
  "data.selected": ({ count }: { count: number }) => `${count} selected`,
  "data.clearSelection": "Clear selection",
  "pager.prev": "Back",
  "pager.next": "Next",
  ...
  "confirm.discardText": "You have unsaved changes. They will be lost if you close this window.",
...
const ru: Messages = {
  ...
  "sidebar.menu": "Открыть меню",
  "home.welcome": "Добро пожаловать",
  "dashboard.title": "Дашборд",
  "dashboard.empty": "Виджеты не настроены",
  "data.add": "Добавить элемент",
  "data.search": "Поиск…",
  "data.loading": "Загрузка…",
  "data.empty": "Пока нет элементов",
  "data.emptySearch": "Ничего не найдено",
  "data.clearSearch": "Сбросить поиск",
  "data.error": "Не удалось загрузить данные",
  "data.retry": "Повторить",
  "filter.clear": ({ count }: { count: number }) => (count > 1 ? "Сбросить фильтры" : "Сбросить фильтр"),
  "filter.all": "Все",
  "data.delete": ({ count }: { count: number }) => (count > 1 ? "Удалить элементы" : "Удалить элемент"),
  "data.selected": ({ count }: { count: number }) => `Выбрано: ${count}`,
  "data.clearSelection": "Снять выделение",
  "pager.prev": "Назад",
  "pager.next": "Вперёд",
  ...
  "confirm.discardTitle": "Отменить изменения?",
  "confirm.discardText": "В форме есть несохранённые изменения. При закрытии они будут потеряны.",
